...
#Samir 
default['cloudfoundry_mongodb_service']['searched_data']['nats_server']['nats_user']=''
default['cloudfoundry_mongodb_service']['searched_data']['nats_server']['nats_password']=''
default['cloudfoundry_mongodb_service']['searched_data']['nats_server']['nats_node']=''
default['cloudfoundry_mongodb_service']['searched_data']['nats_server']['nats_port']=''
default['cloudfoundry_mongodb_service']['searched_data']['cloud_controller']['api_uri']=''

default['cloudfoundry_mongodb_service']['cf_session']['cf_id'] = '9'
default['cloudfoundry_mongodb_service']['cf_session']['name'] = ''
